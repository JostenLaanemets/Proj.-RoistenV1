...
// test, stopping robot while driving
// void testFunction(float left, float right, int channel)
// {
//   if (left > 0.0 && right > 0.0 && channel < 0)
//   {
//     analogWrite(leftMotor, velLeft * -1);
//     analogWrite(rightMotor, velRight * -1);
//   }
// }
